...
write.csv(head(DATAFRAME(rules.gpu), by = "support", n = 15) , "arules_gpu_top15.csv")
```
...
write.csv(head(DATAFRAME(rules.cpu), by = "support", n = 15) , "arules_cpu_top15.csv")
```
...
write.csv(head(DATAFRAME(rules.company), by = "support", n = 15) , "arules_company_top15.csv")
```
...
write.csv(head(DATAFRAME(rules.host), by = "support", n = 15) , "arules_host_top15.csv")
```

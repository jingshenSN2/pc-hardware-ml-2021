...
```{r}
gen_nodes_n_edges = function(my.rules, degree_threshold=20, max_rules=100) {
...
## Sankey
```{r}
rules.cpu = apriori(dat, parameter = list(supp = 20/120000, conf = 0.5, minlen=2),  appearance = list(rhs = c("intel", "amd")))
